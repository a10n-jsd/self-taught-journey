...
14 - Modules | Go to commit: [Lesson](https://github.com/a10n-jsd/self-taught-journey/commits/main/?since=2025-01-20&until=2025-01-22) <br> // use module and re-organize; Generating checkout html (with de-duplicating technique); Fixed price formatting with utils; Fixed radio selector; Delete product from the cart and update the page; Save to localStorage; <br> Go to commit: [Exercise](https://github.com/a10n-jsd/self-taught-journey/commits/main/?since=2025-01-23&until=2025-01-26) <br> // add updateCartQuantity() to header text; Organize cart with calculateCartQuantity() & reuse it; Add update and save cart quantity; add validation to check new quantity; Allow updating by pressing 'Enter';<br> Go to file: <br> [lesson-14](https://github.com/a10n-jsd/self-taught-journey/tree/main/4-add-javascript/1-exercises/lesson-14/javascript-amazon-project)<br> [readme.md]()
